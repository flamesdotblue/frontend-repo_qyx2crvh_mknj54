...
export default function AvatarScene({ speaking = true, bubbleText = '' }) {
  return (
    <div className="relative w-full h-72 md:h-96 lg:h-full rounded-2xl overflow-hidden bg-gradient-to-br from-sky-50 to-rose-50 shadow-xl">
      ...
      {bubbleText ? (
        <div className="absolute left-3 top-3 sm:left-4 sm:top-4 max-w-[70%] pointer-events-none">
          <div className="relative inline-block">
            ...
            {/* Tail of the speech bubble pointing to the avatar (bottom-left) */}
